...
8.  Now you can start creating your own blogposts. While creating the new post use the naming convention as follows " YourFullName_week#_Blogpost"
    Ex: "SathvikThogaru_week1_Blogpost", "John_week1_Blogpost"
